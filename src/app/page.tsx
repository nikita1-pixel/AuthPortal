...
export default function HomePage() {
    ...
    return (
        ...
        <main className="relative min-h-screen bg-[#121212] flex flex-col items-center px-6 overflow-hidden">
              <section className="pt-10 w-full flex flex-col items-center">
            {/* 1. Background Effects */}
            <div className="absolute top-0 left-1/2 -translate-x-1/  w-full h-full">
